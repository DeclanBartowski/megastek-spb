...
<form action="<?=POST_FORM_ACTION_URI?>" method="POST"  class="callback-form">
    ...
    <div class="section-title"><?=GetMessage('TITLE_FORM_ENG')?></div>
    <span class="top-subtitle"><?=GetMessage('SUB_TITLE_ENG')?></span>
    ...
    <input type="submit" class="callback-form_submit main-btn js_form-submit" value="<?=GetMessage('SUBMIT')?>">
